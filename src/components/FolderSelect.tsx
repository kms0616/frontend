        ...
        <div className="flex flex-col gap-[8px] mb-[8px]">
          ...
          <button 
            ...
            className={`flex items-center justify-between w-full h-[56px] px-[16px] rounded-[16px] border ${
              selectedFolder === '전체' ? 'border-[#F3E888] bg-[#FFF5DE]' : 'border-[#000] bg-white'
            }`}
          >
            ...
            {selectedFolder === '전체' ? (
              <div className="flex items-center justify-center w-[24px] h-[24px] bg-[#FFD600] rounded-full shrink-0">
                <svg width="9" height="7" viewBox="0 0 9 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.517334 3.62066L2.93113 6.03445L8.44837 0.517212" stroke="white" strokeWidth="1.03448" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
            ) : (
          ...
          <button 
            ...
            className={`flex items-center justify-between w-full h-[56px] px-[16px] rounded-[16px] border ${
              selectedFolder === '즐겨찾기' ? 'border-[#F3E888] bg-[#FFF5DE]' : 'border-[#E5E5E5] bg-white'
            }`}
          >
            <div className="flex items-center gap-[8px]">
              <span className="text-[20px]">
            ...
            {selectedFolder === '즐겨찾기' ? (
              <div className="flex items-center justify-center w-[24px] h-[24px] bg-[#FFD600] rounded-full shrink-0">
                <svg width="9" height="7" viewBox="0 0 9 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.517334 3.62066L2.93113 6.03445L8.44837 0.517212" stroke="white" stroke-width="1.03448" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
            ) : (
              <div className="flex items-center justify-center w-[24px] h-[24px] bg-[#D9D9D9] rounded-full shrink-0">
