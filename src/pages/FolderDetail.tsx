...
export default function FolderDetail() {
  ...
  const [selectedCollectionCardId, setSelectedCollectionCardId] = useState<
    number | null
  >(null);
  ...
  const tags = [
    {
      id: "cooling",
      label: "냉각력",
      borderColor: "border-[#0DBAEE]",
      bgColor: "bg-[#E5F7FE]",
    },
    {
      id: "mental",
      label: "정신력",
      borderColor: "border-[#A27DDB]",
      bgColor: "bg-[#F3EDFD]",
    },
    {
      id: "stamina",
      label: "체력",
      borderColor: "border-[#00C772]",
      bgColor: "bg-[#E4FAED]",
    },
    {
      id: "wealth",
      label: "자본력",
      borderColor: "border-[#FFA300]",
      bgColor: "bg-[#FFF5DE]",
    },
    {
      id: "endurance",
      label: "인내력",
      borderColor: "border-[#FC504C]",
      bgColor: "bg-[#FEE]",
    },
  ];
  ...
  const handleCardClick = (collectionCardId: number) => {
    setSelectedCollectionCardId(collectionCardId);
    setIsCardOpen(true);
  };
  ...
  return (
    <>
          ...
          {filteredCards.length > 0 ? (
            filteredCards.map((card) => (
              <div
                ...
                onClick={() => handleCardClick(card.collectionCardId)}
              ...
              >
                <div
                  className={`absolute left-0 top-0 bottom-0 w-[12px] border-r border-black ${card.accentColor}`}
                />
      ...
      <CardDetail
        ...
        collectionCardId={selectedCollectionCardId}
      />
    </>
  );
}
