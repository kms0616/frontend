...
const EFFECT_OPTIONS = [
  ...
  { id: "stamina", label: "체력", activeColor: "border-[#00C772] bg-[#E4FAED]", iconColor: "bg-[#00C772]", textColor: "text-[#00C772]", icon: powerIconn },
  { id: "wealth", label: "자본력", activeColor: "border-[#FFA300] bg-[#FFF5DE]", iconColor: "bg-[#FFA300]", textColor: "text-[#FFA300]", icon: capitalIcon },
